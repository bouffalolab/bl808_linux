...
__ALWAYS_INLINE ATTR_TCM_SECTION
    BL_Err_Type
    GLB_DSP_Sub_Reset(GLB_DSP_SUB_Type subPart)
{
    return RomDriver_GLB_DSP_Sub_Reset(subPart);
}
...
__ALWAYS_INLINE ATTR_TCM_SECTION
    BL_Err_Type
    GLB_Set_DSP_CLK(uint8_t enable, GLB_DSP_CLK_Type clkSel, uint8_t div)
{
    return RomDriver_GLB_Set_DSP_CLK(enable, clkSel, div);
}
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
BL_Err_Type GLB_Set_DSP_L2SRAM_Available_Size(uint8_t h2pfSramRel, uint8_t vramSramRel, uint8_t subSramRel, uint8_t blaiSramRel){
    return RomDriver_GLB_Set_DSP_L2SRAM_Available_Size(h2pfSramRel,vramSramRel,subSramRel,blaiSramRel);
}
#endif
__ALWAYS_INLINE ATTR_TCM_SECTION
    BL_Err_Type
